...
export default function Home(){
  ...
  useEffect(()=>{
        ...
        const hospital =`https://api.geoapify.com/v2/places?categories=healthcare.hospital&filter=circle:${latLng.lng},${latLng.lat},5000&bias=proximity:78.5154568,17.5330679&limit=20&apiKey=244aaaef212f4cacad7cf4fee79b74d9`;
