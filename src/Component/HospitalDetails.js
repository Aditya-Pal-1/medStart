...
export default function HospitalDetails() {
  ...
  useEffect(()=>{
      ...
      const ADDRESS_API=`https://api.geoapify.com/v1/geocode/reverse?lat=${latLng.lat}&lon=${latLng.lng}&format=json&apiKey=244aaaef212f4cacad7cf4fee79b74d9`;
  ...
  useEffect(()=>{
    const Direction_Api=`https://api.geoapify.com/v1/routing?waypoints=${latLng.lat},${latLng.lng}|${lat},${lon}&mode=light_truck&apiKey=244aaaef212f4cacad7cf4fee79b74d9`;
